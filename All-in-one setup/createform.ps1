...
<# Begin: DataSource "entra-id-account-update-mail-upn-and-AFAS-user | Entra-ID-Uniqueness-Validation" #>
$tmpPsScript = @'
#######################################################################
...
entra-id-account-update-mail-upn-and-AFAS-user | Entra-ID-Uniqueness-Validation
'@ 
...
<# End: DataSource "entra-id-account-update-mail-upn-and-AFAS-user | Entra-ID-Uniqueness-Validation" #>

<# Begin: DataSource "entra-id-account-update-mail-upn-and-AFAS-user | Entra-ID-Get-Active-Users-DisplayName-Mail-Upn" #>
$tmpPsScript = @'
#######################################################################
# Template: HelloID SA Powershell data source
# Name:     entra-id-account-update-mail-upn-and-AFAS-user | Entra-ID-Get-Active-Users-DisplayName-Mail-Upn
# Date:     12-09-2024
#######################################################################
...
entra-id-account-update-mail-upn-and-AFAS-user | Entra-ID-Get-Active-Users-DisplayName-Mail-Upn
'@ 
...
<# End: DataSource "entra-id-account-update-mail-upn-and-AFAS-user | Entra-ID-Get-Active-Users-DisplayName-Mail-Upn" #>
