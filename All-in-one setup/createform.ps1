...
<# Begin: DataSource "Entra-ID-AFAS-account-update-mail-upn | Entra-ID-Uniqueness-Validation" #>
$tmpPsScript = @'
#######################################################################
...
Entra-ID-AFAS-account-update-mail-upn | Entra-ID-Uniqueness-Validation
'@ 
...
<# End: DataSource "Entra-ID-AFAS-account-update-mail-upn | Entra-ID-Uniqueness-Validation" #>

<# Begin: DataSource "Entra-ID-AFAS-account-update-mail-upn | Entra-ID-Get-Active-Users-DisplayName-Mail-Upn" #>
$tmpPsScript = @'
# Variables configured in form
...
'@ 
$tmpModel = @'
[{"key":"id","type":0},{"key":"userPrincipalName","type":0},{"key":"displayName","type":0},{"key":"employeeId","type":0},{"key":"department","type":0},{"key":"jobTitle","type":0},{"key":"companyName","type":0},{"key":"mail","type":0},{"key":"mailNickname","type":0}]
'@ 
$tmpInput = @'
...
Entra-ID-AFAS-account-update-mail-upn | Entra-ID-Get-Active-Users-DisplayName-Mail-Upn
'@ 
